...
## Overview
Aquí encontrarás el **material complementario** de los análisis de **CVEs** del canal.

Cada entrada incluye: análisis técnico de la falla, impacto, condiciones de explotación y (cuando aplica) una PoC/Demo guiada paso a paso.
...
| [CVE-2021-34527 (PrintNightmare)](./CVE-2021-34527/readme.md) | [![software](https://img.shields.io/badge/software-Windows%20%2F%20Print%20Spooler-0969da?style=flat-square)]() | [![bug](https://img.shields.io/badge/bug-RCE-e11d48?style=flat-square)]() | ❌ | https://youtu.be/Ocw_6P9B8D8 |